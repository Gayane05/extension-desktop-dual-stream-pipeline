...
bool createDevice(HWND hwnd) {
    ...
    for (auto type : {D3D_DRIVER_TYPE_HARDWARE, D3D_DRIVER_TYPE_WARP}) {
        if (SUCCEEDED(D3D11CreateDeviceAndSwapChain(
                nullptr, type, nullptr, 0, levels, 2, D3D11_SDK_VERSION, &sd,
...
int runUi(Pipeline& pipeline, TranscriptModel& model, ISttEngine& engine,
    ...
    WNDCLASSEXW wc = {sizeof(wc), CS_CLASSDC, wndProc, 0, 0,
                      ...
                      nullptr, L"DualStreamTranscriber", nullptr};
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dual-Stream Transcriber",
                                WS_OVERLAPPEDWINDOW, 100, 100, 900, 640, nullptr,
    ...
    while (!done) {
        ...
        // --- transcript ---
        ImGui::BeginChild("transcript", ImVec2(0, 0), 0,
